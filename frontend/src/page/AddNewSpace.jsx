...
import { createSpace } from "../services/authApi";
...
function AddNewSpace() {
    ...
    const handleSubmit = async (event) => {
        ...
        const selectedColorHex = SPACE_COLORS.find((c) => c.value === color)?.hex || "#06B6D4";

        setIsSubmitting(true);
        try {
            await createSpace(trimmedName, description.trim(), selectedColorHex, icon);
            navigate(returnTo);
        } catch (error) {
                ...
                <div className="add-new-space-container">
                    ...
                    <form className="add-new-space-form" onSubmit={handleSubmit}>
                        ...
                        <div className="add-space-form-actions">
                            ...
                            <button className="submit-button" type="submit" disabled={isSubmitting}>Create Space</button>
                        </div>
                    </form>
                </div>
            </main>
